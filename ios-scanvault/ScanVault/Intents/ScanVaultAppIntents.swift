...
/// "Hey Siri, scan a document in ScanVault" — opens straight into the
/// VisionKit document camera.
struct ScanDocumentIntent: AppIntent {
    static var title: LocalizedStringResource = "Scan Document"
    static var description = IntentDescription("Opens ScanVault's document camera to capture a multi-page PDF.")
...
struct ScanVaultShortcuts: AppShortcutsProvider {
